...
contract RetroPunks is ERC721SeaDropPausable {
    ...
    function tokenURI(uint256 tokenId) public tokenExists(tokenId) view override returns (string memory) {
        ...
        return _renderDataUri(tokenId, data.tokenIdSeed, data.backgroundIndex, name, globalSeed);
    }
    ...
    function _renderDataUri(uint256 _tokenId, uint16 _tokenIdSeed, uint8 _backgroundIndex, string memory _name, uint256 _globalSeed) internal view returns (string memory) {

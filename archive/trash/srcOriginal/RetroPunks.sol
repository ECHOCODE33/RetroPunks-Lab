...
import { NUM_BACKGROUND, E_Background } from "./common/Enums.sol";
...
contract RetroPunks is ERC721SeaDropPausableAndQueryable, FisherYatesShuffler {
    ...
    function setName(uint tokenId, string memory name) public onlyTokenOwner(tokenId) {
    ...
    function resetName(uint256 tokenId) public onlyTokenOwner(tokenId) {
    ...
    // Reveal function for globalSeed (call after mint closes)
    ...
    // Reveal function for shufflerSeed (call before mint starts)

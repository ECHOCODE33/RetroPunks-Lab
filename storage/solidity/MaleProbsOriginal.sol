...
//         if (TraitsLib.maleIsGhost(traits)) {
...
//         if (TraitsLib.maleIsHuman(traits) || TraitsLib.maleIsZombie(traits)) {
...
//         else if (TraitsLib.maleIsApe(traits) || TraitsLib.maleIsYeti(traits) || TraitsLib.maleIsZombieApe(traits)) {
...
//         else if (TraitsLib.maleIsAlien(traits) || TraitsLib.maleIsDemon(traits) || TraitsLib.maleIsGhost(traits) || TraitsLib.maleIsGlitch(traits) || TraitsLib.maleIsGoblin(traits) || TraitsLib.maleIsPumpkin(traits) || TraitsLib.maleIsSkeleton(traits) || TraitsLib.maleIsVampire(traits)) {
...
//         if (!TraitsLib.maleIsHuman(traits) && !TraitsLib.maleIsZombie(traits) && !TraitsLib.maleIsGhost(traits)) {
//             return E_Male_Facial_Hair.None;
//         }

//         else if (TraitsLib.maleIsGhost(traits)) {
...
//         // None = 9520
//             probs[uint(E_Male_Mask.None)] = 9530;
...
//         else if (TraitsLib.maleIsRobot(traits) || TraitsLib.maleIsMummy(traits) || TraitsLib.maleIsVampire(traits)) {
...
//         if (TraitsLib.maleIsRobot(traits) || TraitsLib.maleIsMummy(traits) || TraitsLib.maleIsVampire(traits)) {
//             return E_Male_Hat_Hair.None;
//         }

//         else if (TraitsLib.maleIsHuman(traits) || TraitsLib.maleIsZombie(traits)) {
...
//         if (TraitsLib.maleHasBlackFacialHair(traits)) {

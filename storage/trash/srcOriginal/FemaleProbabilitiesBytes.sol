...
contract FemaleProbabilities is IFemaleProbabilities {

    function selectFemaleSkinType(RandomCtx memory rndCtx) external pure returns (E_Female_Skin) {
        uint16[] memory probs = new uint16[](25);
    ...
    function selectFemaleHeadwear(RandomCtx memory rndCtx) external pure returns (E_Female_Headwear) {
        ...
        // Tier 4 = 538
                ...
                // Cloak = 45
                    probs[uint(E_Female_Headwear.Cloak_Blue)] = 9;
                    probs[uint(E_Female_Headwear.Cloak_Green)] = 9;
                    probs[uint(E_Female_Headwear.Cloak_Purple)] = 9;
                    probs[uint(E_Female_Headwear.Cloak_Red)] = 9;
                    probs[uint(E_Female_Headwear.Cloak)] = 9;
    ...
    function selectFemaleEyeWear(RandomCtx memory rndCtx) external pure returns (E_Female_Eye_Wear) {
        uint16[] memory probs = new uint16[](121);
        ...
        // Tier 1 = 4000
            ...
            // Square Glasses = 576
                probs[uint(E_Female_Eye_Wear.Square_Glasses_Blue)] = 72;
                probs[uint(E_Female_Eye_Wear.Square_Glasses_Green)] = 72;
                probs[uint(E_Female_Eye_Wear.Square_Glasses_Orange)] = 72;
                probs[uint(E_Female_Eye_Wear.Square_Glasses_Pink)] = 72;
                probs[uint(E_Female_Eye_Wear.Square_Glasses_Purple)] = 72;
                probs[uint(E_Female_Eye_Wear.Square_Glasses_Red)] = 72;
                probs[uint(E_Female_Eye_Wear.Square_Glasses_Turquoise)] = 72;
                probs[uint(E_Female_Eye_Wear.Square_Glasses_Yellow)] = 72;

            // Circle Glasses = 576
                probs[uint(E_Female_Eye_Wear.Circle_Glasses_Blue)] = 72;
                probs[uint(E_Female_Eye_Wear.Circle_Glasses_Green)] = 72;
                probs[uint(E_Female_Eye_Wear.Circle_Glasses_Orange)] = 72;
                probs[uint(E_Female_Eye_Wear.Circle_Glasses_Pink)] = 72;
                probs[uint(E_Female_Eye_Wear.Circle_Glasses_Purple)] = 72;
                probs[uint(E_Female_Eye_Wear.Circle_Glasses_Red)] = 72;
                probs[uint(E_Female_Eye_Wear.Circle_Glasses_Turquoise)] = 72;
                probs[uint(E_Female_Eye_Wear.Circle_Glasses_Yellow)] = 72;

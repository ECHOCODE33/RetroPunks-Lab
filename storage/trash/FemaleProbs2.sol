...
contract FemaleProbs is IFemaleProbs {
    ...
    error SelectionFailed(uint256 randomValue, uint256 totalWeight);

    function _select(RandomCtx memory rndCtx, uint16[] memory probs, uint256 totalWeight) internal pure returns (uint256) {
        uint256 r = nextUint(rndCtx, totalWeight);
        ...
        revert SelectionFailed(r, totalWeight);
    }
    ...
    function selectFemaleSkin(RandomCtx memory rndCtx) external pure returns (E_Female_Skin) {
        ...
        unchecked {
            probs[uint(E_Female_Skin.None)]       = 0;     // weight: 0 (0%)
            probs[uint(E_Female_Skin.Human_1)]    = 750;   // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_2)]    = 1500;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_3)]    = 2250;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_4)]    = 3000;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_5)]    = 3750;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_6)]    = 4500;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_7)]    = 5250;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_8)]    = 6000;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_9)]    = 6750;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_10)]   = 7500;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_11)]   = 8250;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Human_12)]   = 9000;  // weight: 750 (7.5%)
            probs[uint(E_Female_Skin.Zombie)]     = 9300;  // weight: 300 (3%)
            probs[uint(E_Female_Skin.Ape)]        = 9525;  // weight: 225 (2.25%)
            probs[uint(E_Female_Skin.Zombie_Ape)] = 9675;  // weight: 150 (1.5%)
            probs[uint(E_Female_Skin.Robot)]      = 9765;  // weight: 90 (0.9%)
            probs[uint(E_Female_Skin.Glitch)]     = 9830;  // weight: 65 (0.65%)
            probs[uint(E_Female_Skin.Ghost)]      = 9875;  // weight: 45 (0.45%)
            probs[uint(E_Female_Skin.Alien)]      = 9900;  // weight: 25 (0.25%)
            probs[uint(E_Female_Skin.Mummy)]      = 9925;  // weight: 25 (0.25%)
            probs[uint(E_Female_Skin.Skeleton)]   = 9947;  // weight: 22 (0.22%)
            probs[uint(E_Female_Skin.Goblin)]     = 9967;  // weight: 20 (0.2%)
            probs[uint(E_Female_Skin.Demon)]      = 9982;  // weight: 15 (0.15%)
            probs[uint(E_Female_Skin.Vampire)]    = 9992;  // weight: 10 (0.1%)
            probs[uint(E_Female_Skin.Invisible)]  = 10000; // weight: 8 (0.08%)
        }

        return E_Female_Skin(_select(rndCtx, probs, 10000));
    }
    ...
    function selectFemaleEyes(TraitsContext calldata traits, RandomCtx memory rndCtx) external pure returns (E_Female_Eyes) {
        ...
        if (TraitsUtils.femaleIsGhost(traits)) {
            unchecked {
                probs[uint(E_Female_Eyes.Ghost_Left)]           = 5000;  // weight: 5000 (50%)
                probs[uint(E_Female_Eyes.Ghost_Right)]          = 10000; // weight: 5000 (50%)
            }

            return E_Female_Eyes(_select(rndCtx, probs, 10000));
        }

        else {
            unchecked {
                probs[uint(E_Female_Eyes.None)]                 = 0;     // weight: 0 (0%)
                probs[uint(E_Female_Eyes.Left)]                 = 4125;  // weight: 4125 (40.2871%)
                probs[uint(E_Female_Eyes.Right)]                = 8250;  // weight: 4125 (40.2871%)
                probs[uint(E_Female_Eyes.Tired_Left)]           = 8750;  // weight: 500 (4.88329%)
                probs[uint(E_Female_Eyes.Tired_Right)]          = 9250;  // weight: 500 (4.88329%)
                probs[uint(E_Female_Eyes.Confused)]             = 9500;  // weight: 250 (2.44164%)
                probs[uint(E_Female_Eyes.Tired_Confused)]       = 9625;  // weight: 125 (1.22082%)
                probs[uint(E_Female_Eyes.Closed)]               = 9725;  // weight: 100 (0.976658%)
                probs[uint(E_Female_Eyes.Wink)]                 = 9800;  // weight: 75 (0.732493%)
                probs[uint(E_Female_Eyes.Blind)]                = 9850;  // weight: 50 (0.488329%)
                probs[uint(E_Female_Eyes.Eye_Shadow_Blue)]      = 9880;  // weight: 30 (0.292997%)
                probs[uint(E_Female_Eyes.Eye_Shadow_Green)]     = 9910;  // weight: 30 (0.292997%)
                probs[uint(E_Female_Eyes.Eye_Shadow_Orange)]    = 9940;  // weight: 30 (0.292997%)
                probs[uint(E_Female_Eyes.Eye_Shadow_Pink)]      = 9970;  // weight: 30 (0.292997%)
                probs[uint(E_Female_Eyes.Eye_Shadow_Purple)]    = 10000; // weight: 30 (0.292997%)
                probs[uint(E_Female_Eyes.Eye_Shadow_Red)]       = 10030; // weight: 30 (0.292997%)
                probs[uint(E_Female_Eyes.Eye_Shadow_Turquoise)] = 10060; // weight: 30 (0.292997%)
                probs[uint(E_Female_Eyes.Eye_Shadow_Yellow)]    = 10090; // weight: 30 (0.292997%)
                probs[uint(E_Female_Eyes.Clown_Eyes_Blue)]      = 10101; // weight: 11 (0.107432%)
                probs[uint(E_Female_Eyes.Clown_Eyes_Green)]     = 10112; // weight: 11 (0.107432%)
                probs[uint(E_Female_Eyes.Clown_Eyes_Orange)]    = 10123; // weight: 11 (0.107432%)
                probs[uint(E_Female_Eyes.Clown_Eyes_Pink)]      = 10134; // weight: 11 (0.107432%)
                probs[uint(E_Female_Eyes.Clown_Eyes_Purple)]    = 10145; // weight: 11 (0.107432%)
                probs[uint(E_Female_Eyes.Clown_Eyes_Red)]       = 10156; // weight: 11 (0.107432%)
                probs[uint(E_Female_Eyes.Clown_Eyes_Sky_Blue)]  = 10167; // weight: 11 (0.107432%)
                probs[uint(E_Female_Eyes.Clown_Eyes_Turquoise)] = 10178; // weight: 11 (0.107432%)
                probs[uint(E_Female_Eyes.Clown_Eyes_Yellow)]    = 10189; // weight: 11 (0.107432%)
                probs[uint(E_Female_Eyes.Possessed_Left)]       = 10214; // weight: 25 (0.244164%)
                probs[uint(E_Female_Eyes.Possessed_Right)]      = 10239; // weight: 25 (0.244164%)
            }

            return E_Female_Eyes(_select(rndCtx, probs, 10239));
        }
    ...
    function selectFemaleFace(TraitsContext calldata traits, RandomCtx memory rndCtx) external pure returns (E_Female_Face) {
        ...
        if (TraitsUtils.femaleIsHuman(traits) || TraitsUtils.femaleIsZombie(traits)) {
        ...
        else if (TraitsUtils.femaleIsApe(traits) || TraitsUtils.femaleIsZombieApe(traits)) {
        ...
        else if (TraitsUtils.femaleIsAlien(traits) || TraitsUtils.femaleIsDemon(traits) || TraitsUtils.femaleIsGhost(traits) || TraitsUtils.femaleIsGlitch(traits) || TraitsUtils.femaleIsGoblin(traits) || TraitsUtils.femaleIsSkeleton(traits) || TraitsUtils.femaleIsVampire(traits)) {
    ...
    function selectFemaleHair(TraitsContext calldata traits, RandomCtx memory rndCtx) external pure returns (E_Female_Hair) {
        ...
        else if (TraitsUtils.femaleIsRobot(traits) || TraitsUtils.femaleIsMummy(traits) || TraitsUtils.femaleIsVampire(traits)) {

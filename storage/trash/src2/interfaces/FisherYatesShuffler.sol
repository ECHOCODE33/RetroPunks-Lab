...
abstract contract FisherYatesShuffler {
     ...
     */
    function drawNextElement(uint seed, address msgSender, uint remaining) internal virtual returns (uint result) {
        ...
        // Fisher-Yates shuffle algorithm without pre-initialized array 

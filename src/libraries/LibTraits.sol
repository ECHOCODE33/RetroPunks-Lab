...
library LibTraits {
    ...
    uint256 private constant MALE_EYEWEAR_IS_EYE_PATCH = (
        (1 << uint256(E_Male_Eye_Wear.Bionic_Eye_Patch_Blue)) |
        (1 << uint256(E_Male_Eye_Wear.Bionic_Eye_Patch_Green)) |
        (1 << uint256(E_Male_Eye_Wear.Bionic_Eye_Patch_Orange)) |
        (1 << uint256(E_Male_Eye_Wear.Bionic_Eye_Patch_Pink)) |
        (1 << uint256(E_Male_Eye_Wear.Bionic_Eye_Patch_Purple)) |
        (1 << uint256(E_Male_Eye_Wear.Bionic_Eye_Patch_Red)) |
        (1 << uint256(E_Male_Eye_Wear.Bionic_Eye_Patch_Turquoise)) |
        (1 << uint256(E_Male_Eye_Wear.Bionic_Eye_Patch_Yellow)) |
        (1 << uint256(E_Male_Eye_Wear.Eye_Patch)) |
        (1 << uint256(E_Male_Eye_Wear.Pirate_Eye_Patch)) |
        (1 << uint256(E_Male_Eye_Wear.Eye_Mask))
    );

    uint256 private constant MALE_HEADWEAR_IS_CLOAK_OR_HOODIE = (
        (uint256(1) << uint256(E_Male_Headwear.Cloak_Black)) |
        (uint256(1) << uint256(E_Male_Headwear.Cloak_Blue)) |
        (uint256(1) << uint256(E_Male_Headwear.Cloak_Green)) |
        (uint256(1) << uint256(E_Male_Headwear.Cloak_Purple)) |
        (uint256(1) << uint256(E_Male_Headwear.Cloak_Red)) |
        (uint256(1) << uint256(E_Male_Headwear.Cloak_White)) |
        (uint256(1) << uint256(E_Male_Headwear.Cloak)) |
        (uint256(1) << uint256(E_Male_Headwear.Hoodie_Blue)) |
        (uint256(1) << uint256(E_Male_Headwear.Hoodie_Green)) |
        (uint256(1) << uint256(E_Male_Headwear.Hoodie_Purple)) |
        (uint256(1) << uint256(E_Male_Headwear.Hoodie_Red)) |
        (uint256(1) << uint256(E_Male_Headwear.Hoodie)) |
        (uint256(1) << uint256(E_Male_Headwear.Sherpa_Hat_Blue)) |
        (uint256(1) << uint256(E_Male_Headwear.Sherpa_Hat_Brown)) |
        (uint256(1) << uint256(E_Male_Headwear.Sherpa_Hat_Red))
    );

    uint256 private constant FEMALE_EYEWEAR_IS_EYE_PATCH = (
        (1 << uint256(E_Female_Eye_Wear.Bionic_Eye_Patch_Blue)) |
        (1 << uint256(E_Female_Eye_Wear.Bionic_Eye_Patch_Green)) |
        (1 << uint256(E_Female_Eye_Wear.Bionic_Eye_Patch_Orange)) |
        (1 << uint256(E_Female_Eye_Wear.Bionic_Eye_Patch_Pink)) |
        (1 << uint256(E_Female_Eye_Wear.Bionic_Eye_Patch_Purple)) |
        (1 << uint256(E_Female_Eye_Wear.Bionic_Eye_Patch_Red)) |
        (1 << uint256(E_Female_Eye_Wear.Bionic_Eye_Patch_Turquoise)) |
        (1 << uint256(E_Female_Eye_Wear.Bionic_Eye_Patch_Yellow)) |
        (1 << uint256(E_Female_Eye_Wear.Eye_Patch)) |
        (1 << uint256(E_Female_Eye_Wear.Pirate_Eye_Patch)) |
        (1 << uint256(E_Female_Eye_Wear.Eye_Mask))
    );

    uint256 private constant FEMALE_HEADWEAR_IS_CLOAK_OR_HOODIE = (
        (uint256(1) << uint256(E_Female_Headwear.Cloak_Black)) |
        (uint256(1) << uint256(E_Female_Headwear.Cloak_Blue)) |
        (uint256(1) << uint256(E_Female_Headwear.Cloak_Green)) |
        (uint256(1) << uint256(E_Female_Headwear.Cloak_Purple)) |
        (uint256(1) << uint256(E_Female_Headwear.Cloak_Red)) |
        (uint256(1) << uint256(E_Female_Headwear.Cloak_White)) |
        (uint256(1) << uint256(E_Female_Headwear.Cloak)) |
        (uint256(1) << uint256(E_Female_Headwear.Hoodie_Blue)) |
        (uint256(1) << uint256(E_Female_Headwear.Hoodie_Green)) |
        (uint256(1) << uint256(E_Female_Headwear.Hoodie_Purple)) |
        (uint256(1) << uint256(E_Female_Headwear.Hoodie_Red)) |
        (uint256(1) << uint256(E_Female_Headwear.Hoodie)) |
        (uint256(1) << uint256(E_Female_Headwear.Sherpa_Hat_Blue)) |
        (uint256(1) << uint256(E_Female_Headwear.Sherpa_Hat_Brown)) |
